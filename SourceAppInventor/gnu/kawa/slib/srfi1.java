...
public class srfi1 extends ModuleBody {
    ...
    public static final ModuleMethod f86break;
    ...
    public class frame10 extends ModuleBody {
        ...
        public Object lambda19recur(Object lists) {
            ...
            return Scheme.apply.apply2(this.f21f, srfi1.append$Ex$V(new Object[]{lists, LList.list1(lambda19recur(cdrs))}));
        }

        public Object lambda20recur(Object lis) {
            return srfi1.isNullList(lis) != Boolean.FALSE ? this.zero : this.f21f.apply2(lis, lambda20recur(lists.cdr.apply1(lis)));
        }
    }
    ...
    public class frame11 extends ModuleBody {
        ...
        public Object lambda21recur(Object head, Object lis) {
            if (lists.isPair(lis)) {
                return this.f22f.apply2(head, lambda21recur(lists.car.apply1(lis), lists.cdr.apply1(lis)));
            }
            return head;
        }
    }
    ...
    public class frame12 extends ModuleBody {
        ...
        void lambda22(Object pair) {
            try {
                lists.setCar$Ex((Pair) pair, this.f23f.apply1(lists.car.apply1(pair)));
    ...
    public class frame14 extends ModuleBody {
        ...
        Object lambda25(Object cars, Object cdrs) {
            ...
            Boolean head = Scheme.apply.apply2(this.staticLink.f24f, cars);
    ...
    public class frame18 extends ModuleBody {
        ...
        boolean lambda29(Object y) {
            return ((Scheme.applyToArgs.apply3(this.maybe$Mn$Eq, this.f26x, y) != Boolean.FALSE ? 1 : 0) + 1) & 1;
        }
    ...
    public class frame30 extends ModuleBody {
        ...
        public Object lambda44lp(Object lists, Object n) {
            ...
            gnu_kawa_slib_srfi1_frame31.f27n = n;
    ...
    public class frame31 extends ModuleBody {
        ...
        Object lambda46(Object heads, Object tails) {
            ...
            if (!x) {
                ...
                return this.staticLink.lambda44lp(tails, AddOp.$Pl.apply2(this.f27n, srfi1.Lit1));
            }
        }
    ...
    public class frame37 extends ModuleBody {
        ...
        Object lambda54(Object x) {
            ...
            gnu_kawa_slib_srfi1_frame38.f28x = x;
    ...
    public class frame39 extends ModuleBody {
        ...
        Object lambda56(Object x) {
            ...
            gnu_kawa_slib_srfi1_frame40.f29x = x;
    ...
    public class frame40 extends ModuleBody {
        ...
        Object lambda57(Object lis) {
            return lists.member(this.f29x, lis, this.staticLink.$Eq);
        }
    ...
    public class frame41 extends ModuleBody {
        ...
        Object lambda58(Object x) {
            ...
            gnu_kawa_slib_srfi1_frame42.f30x = x;
    ...
    public class frame43 extends ModuleBody {
        ...
        Object lambda60(Object x) {
            ...
            gnu_kawa_slib_srfi1_frame44.f31x = x;
    ...
    public class frame44 extends ModuleBody {
        ...
        boolean lambda61(Object lis) {
            return ((lists.member(this.f31x, lis, this.staticLink.$Eq) != Boolean.FALSE ? 1 : 0) + 1) & 1;
        }
    ...
    public class frame45 extends ModuleBody {
        ...
        Object lambda62(Object b, Object a) {
            ...
            gnu_kawa_slib_srfi1_frame46.f33b = b;
            gnu_kawa_slib_srfi1_frame46.f32a = a;
    ...
    public class frame46 extends ModuleBody {
        ...
        Object lambda63() {
            return srfi1.lsetDiff$PlIntersection$V(this.staticLink.$Eq, this.f32a, new Object[]{this.f33b});
        }
        ...
        Object lambda64(Object a$Mnb, Object aIntB) {
            ...
            if (lists.isNull(a$Mnb)) {
                return srfi1.lsetDifference$V(this.staticLink.$Eq, this.f33b, new Object[]{this.f32a});
            } else if (!lists.isNull(gnu_kawa_slib_srfi1_frame47.a$Mnint$Mnb)) {
                return srfi1.fold$V(gnu_kawa_slib_srfi1_frame47.lambda$Fn48, a$Mnb, this.f33b, new Object[0]);
            } else {
                return append.append$V(new Object[]{this.f33b, this.f32a});
            }
        }
    ...
    public class frame48 extends ModuleBody {
        ...
        Object lambda66(Object b, Object a) {
            ...
            gnu_kawa_slib_srfi1_frame49.f35b = b;
            gnu_kawa_slib_srfi1_frame49.f34a = a;
    ...
    public class frame49 extends ModuleBody {
        ...
        Object lambda67() {
            return srfi1.lsetDiff$PlIntersection$Ex$V(this.staticLink.$Eq, this.f34a, new Object[]{this.f35b});
        }
        ...
        Object lambda68(Object a$Mnb, Object aIntB) {
            ...
            if (lists.isNull(a$Mnb)) {
                return srfi1.lsetDifference$Ex$V(this.staticLink.$Eq, this.f35b, new Object[]{this.f34a});
            } else if (!lists.isNull(gnu_kawa_slib_srfi1_frame50.a$Mnint$Mnb)) {
                return srfi1.pairFold$V(gnu_kawa_slib_srfi1_frame50.lambda$Fn52, a$Mnb, this.f35b, new Object[0]);
            } else {
                return srfi1.append$Ex$V(new Object[]{this.f35b, this.f34a});
            }
        }
    ...
    public class frame59 extends ModuleBody {
        ...
        Object lambda80(Object a, Object d) {
            ...
            gnu_kawa_slib_srfi1_frame60.f36a = a;
            gnu_kawa_slib_srfi1_frame60.f37d = d;
    ...
    public class frame60 extends ModuleBody {
        ...
        Object lambda82(Object cars, Object cdrs) {
            return misc.values(lists.cons(this.f36a, cars), lists.cons(this.f37d, cdrs));
        }
    ...
    public class frame65 extends ModuleBody {
        ...
        Object lambda89(Object a, Object d) {
            ...
            gnu_kawa_slib_srfi1_frame66.f38a = a;
            gnu_kawa_slib_srfi1_frame66.f39d = d;
    ...
    public class frame66 extends ModuleBody {
        ...
        Object lambda91(Object cars, Object cdrs) {
            return misc.values(lists.cons(this.f38a, cars), lists.cons(this.f39d, cdrs));
        }
    ...
    public class frame69 extends ModuleBody {
        ...
        Object lambda96(Object a, Object d) {
            ...
            gnu_kawa_slib_srfi1_frame70.f40a = a;
            gnu_kawa_slib_srfi1_frame70.f41d = d;
    ...
    public class frame70 extends ModuleBody {
        ...
        Object lambda98(Object cars, Object cdrs) {
            return misc.values(lists.cons(this.f40a, cars), lists.cons(this.f41d, cdrs));
        }
    ...
    static {
        ...
        f86break = new ModuleMethod(moduleBody, 164, Lit80, 8194);
    ...
    public static Object pairFoldRight$V(Procedure f, Object zero, Object lis1, Object[] argsArray) {
        ...
        gnu_kawa_slib_srfi1_frame10.f21f = f;
    ...
    public static Object reduceRight(Procedure f, Object ridentity, Object lis) {
        ...
        gnu_kawa_slib_srfi1_frame11.f22f = f;
    ...
    public static Object map$Ex$V(Procedure f, Object lis1, Object[] argsArray) {
        ...
        gnu_kawa_slib_srfi1_frame12.f23f = f;
        Object lists = LList.makeList(argsArray, 0);
        if (lists.isPair(lists)) {
            Object lis12 = lis1;
            while (isNullList(lis12) == Boolean.FALSE) {
                ...
                try {
                    lists.setCar$Ex((Pair) lis12, Scheme.apply.apply3(gnu_kawa_slib_srfi1_frame12.f23f, lists.car.apply1(lis12), heads));
    ...
    public static Object filterMap$V(Procedure f, Object lis1, Object[] argsArray) {
        ...
        gnu_kawa_slib_srfi1_frame13.f24f = f;
        LList lists = LList.makeList(argsArray, 0);
        if (lists.isPair(lists)) {
        ...
        Object lis = lis1;
        while (isNullList(lis) == Boolean.FALSE) {
            Boolean head = gnu_kawa_slib_srfi1_frame13.f24f.apply1(lists.car.apply1(lis));
            Object tail = lists.cdr.apply1(lis);
            if (head != Boolean.FALSE) {
    ...
    public static Object delete(Object x, Object lis, Object maybe$Mn$Eq) {
        ...
        gnu_kawa_slib_srfi1_frame17.f25x = x;
    ...
    public static Object delete$Ex(Object x, Object lis, Object maybe$Mn$Eq) {
        ...
        gnu_kawa_slib_srfi1_frame18.f26x = x;
