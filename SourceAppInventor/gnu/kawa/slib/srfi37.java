...
public class srfi37 extends ModuleBody {
    ...
    public class frame3 extends ModuleBody {
        ...
        Object lambda17(Object x) {
            ...
            gnu_kawa_slib_srfi37_frame4.f87x = x;
    ...
    public class frame4 extends ModuleBody {
        ...
        Object lambda19(Object x) {
            ...
            gnu_kawa_slib_srfi37_frame5.f88x = x;
    ...
    public class frame5 extends ModuleBody {
        ...
        Object lambda21(Object x) {
            ...
            gnu_kawa_slib_srfi37_frame6.f89x = x;
            return call_with_values.callWithValues(gnu_kawa_slib_srfi37_frame6.lambda$Fn17, gnu_kawa_slib_srfi37_frame6.lambda$Fn18);
        }

        Object lambda20() {
            Boolean x = this.staticLink.staticLink.staticLink.lambda2findOption(this.staticLink.f87x);
            return x != Boolean.FALSE ? x : srfi37.option(LList.list1(this.staticLink.f87x), Boolean.TRUE, Boolean.FALSE, this.staticLink.staticLink.staticLink.unrecognized$Mnoption$Mnproc);
        }
    }
    ...
    public class frame6 extends ModuleBody {
        ...
        Object lambda22() {
            Procedure procedure = Scheme.apply;
            Object[] objArr = new Object[5];
            Object obj = this.f89x;
            try {
                objArr[0] = srfi37.optionProcessor((option$Mntype) obj);
                objArr[1] = this.f89x;
                objArr[2] = this.staticLink.staticLink.f87x;
                objArr[3] = this.staticLink.f88x;
