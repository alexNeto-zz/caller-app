...
public class pregexp extends ModuleBody {
    ...
    public class frame0 extends ModuleBody {
        ...
        public Object lambda5loupOneOfChars(Object chars) {
            ...
            return this.staticLink.lambda3sub(lists.car.apply1(gnu_kawa_slib_pregexp_frame1.chars), this.f9i, this.sk, gnu_kawa_slib_pregexp_frame1.lambda$Fn13);
        }
        ...
        Object lambda10() {
            return Scheme.applyToArgs.apply2(this.sk, AddOp.$Pl.apply2(this.f9i, pregexp.Lit8));
        }
        ...
        public Object lambda7loupOr(Object res) {
            ...
            return this.staticLink.lambda3sub(lists.car.apply1(gnu_kawa_slib_pregexp_frame3.res), this.f9i, gnu_kawa_slib_pregexp_frame3.lambda$Fn15, gnu_kawa_slib_pregexp_frame3.lambda$Fn16);
        }
        ...
        Object lambda12(Object i1) {
            ...
            try {
                lists.setCdr$Ex((Pair) assv, lists.cons(this.f9i, i1));
        ...
        public Object lambda8loupP(Object k, Object i) {
            ...
            gnu_kawa_slib_pregexp_frame4.f13k = k;
            gnu_kawa_slib_pregexp_frame4.f12i = i;
            if (Scheme.numLss.apply2(gnu_kawa_slib_pregexp_frame4.f13k, this.f10p) != Boolean.FALSE) {
                return this.staticLink.lambda3sub(this.re, gnu_kawa_slib_pregexp_frame4.f12i, gnu_kawa_slib_pregexp_frame4.lambda$Fn17, this.fk);
            }
            gnu_kawa_slib_pregexp_frame4.f14q = this.f11q != Boolean.FALSE ? AddOp.$Mn.apply2(this.f11q, this.f10p) : this.f11q;
            return gnu_kawa_slib_pregexp_frame4.lambda24loupQ(pregexp.Lit73, gnu_kawa_slib_pregexp_frame4.f12i);
        }
    }
    ...
    public class frame4 extends ModuleBody {
        ...
        public Object lambda24loupQ(Object k, Object i) {
            ...
            gnu_kawa_slib_pregexp_frame5.f16k = k;
            gnu_kawa_slib_pregexp_frame5.f15i = i;
            gnu_kawa_slib_pregexp_frame5.fk = gnu_kawa_slib_pregexp_frame5.fk;
            if (this.f14q == Boolean.FALSE ? this.f14q != Boolean.FALSE : Scheme.numGEq.apply2(gnu_kawa_slib_pregexp_frame5.f16k, this.f14q) != Boolean.FALSE) {
                return gnu_kawa_slib_pregexp_frame5.lambda26fk();
            }
            if (this.staticLink.maximal$Qu) {
                return this.staticLink.staticLink.lambda3sub(this.staticLink.re, gnu_kawa_slib_pregexp_frame5.f15i, gnu_kawa_slib_pregexp_frame5.lambda$Fn18, gnu_kawa_slib_pregexp_frame5.fk);
            }
            Boolean x = gnu_kawa_slib_pregexp_frame5.lambda26fk();
            return x == Boolean.FALSE ? this.staticLink.staticLink.lambda3sub(this.staticLink.re, gnu_kawa_slib_pregexp_frame5.f15i, gnu_kawa_slib_pregexp_frame5.lambda$Fn19, gnu_kawa_slib_pregexp_frame5.fk) : x;
        }
    }
    ...
    public class frame5 extends ModuleBody {
        ...
        public Object lambda26fk() {
            return Scheme.applyToArgs.apply2(this.staticLink.staticLink.sk, this.f15i);
        }
        ...
        Object lambda28(Object i1) {
            return this.staticLink.lambda24loupQ(AddOp.$Pl.apply2(this.f16k, pregexp.Lit8), i1);
        }
    }
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda3sub(Object re, Object i, Object sk, Object fk) {
            ...
            gnu_kawa_slib_pregexp_frame0.f9i = i;
            ...
            if (Scheme.isEqv.apply2(gnu_kawa_slib_pregexp_frame0.re$1, pregexp.Lit10) != Boolean.FALSE) {
                if (Scheme.numEqu.apply2(gnu_kawa_slib_pregexp_frame0.f9i, this.start) != Boolean.FALSE) {
                    return Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, gnu_kawa_slib_pregexp_frame0.f9i);
                }
                ...
                return Scheme.numGEq.apply2(gnu_kawa_slib_pregexp_frame0.f9i, this.f17n) != Boolean.FALSE ? Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, gnu_kawa_slib_pregexp_frame0.f9i) : Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk);
            } else {
                ...
                if (Scheme.isEqv.apply2(gnu_kawa_slib_pregexp_frame0.re$1, pregexp.Lit26) != Boolean.FALSE) {
                    if (pregexp.isPregexpAtWordBoundary(this.f18s, gnu_kawa_slib_pregexp_frame0.f9i, this.f17n) != Boolean.FALSE) {
                        return Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, gnu_kawa_slib_pregexp_frame0.f9i);
                    }
                    return Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk);
                    ...
                    if (x ? Scheme.numLss.apply2(gnu_kawa_slib_pregexp_frame0.f9i, this.f17n) != Boolean.FALSE : x) {
                        Procedure procedure = this.case$Mnsensitive$Qu != Boolean.FALSE ? characters.char$Eq$Qu : unicode.char$Mnci$Eq$Qu;
                        obj = this.f18s;
                        try {
                            charSequence = (CharSequence) obj;
                            obj2 = gnu_kawa_slib_pregexp_frame0.f9i;
                            try {
                                return procedure.apply2(Char.make(strings.stringRef(charSequence, ((Number) obj2).intValue())), gnu_kawa_slib_pregexp_frame0.re$1) != Boolean.FALSE ? Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, AddOp.$Pl.apply2(gnu_kawa_slib_pregexp_frame0.f9i, pregexp.Lit8)) : Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk);
                            } catch (ClassCastException e) {
                        ...
                        try {
                            ...
                            try {
                                if (pregexp.isPregexpCheckIfInCharClass(Char.make(strings.stringRef(charSequence, ((Number) obj2).intValue())), gnu_kawa_slib_pregexp_frame0.re$1) != Boolean.FALSE) {
                                    return Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, AddOp.$Pl.apply2(gnu_kawa_slib_pregexp_frame0.f9i, pregexp.Lit8));
                                }
                                return Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk);
                    ...
                    if (x3 != null) {
                        ...
                        if (lists.isPair(gnu_kawa_slib_pregexp_frame0.re$1)) {
                            ...
                            if (Scheme.isEqv.apply2(tmp, pregexp.Lit83) != Boolean.FALSE) {
                                if (Scheme.numGEq.apply2(gnu_kawa_slib_pregexp_frame0.f9i, this.f17n) != Boolean.FALSE) {
                                    return Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk);
                                }
                                ...
                                return lambda3sub(lists.cadr.apply1(gnu_kawa_slib_pregexp_frame0.re$1), gnu_kawa_slib_pregexp_frame0.f9i, gnu_kawa_slib_pregexp_frame0.lambda$Fn2, gnu_kawa_slib_pregexp_frame0.lambda$Fn3);
                            } else if (Scheme.isEqv.apply2(tmp, pregexp.Lit5) != Boolean.FALSE) {
                                return gnu_kawa_slib_pregexp_frame0.lambda6loupSeq(lists.cdr.apply1(gnu_kawa_slib_pregexp_frame0.re$1), gnu_kawa_slib_pregexp_frame0.f9i);
                            } else {
                                ...
                                if (Scheme.isEqv.apply2(tmp, pregexp.Lit20) != Boolean.FALSE) {
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            try {
                                                return pregexp.pregexpStringMatch(strings.substring(charSequence, intValue, ((Number) obj2).intValue()), this.f18s, gnu_kawa_slib_pregexp_frame0.f9i, this.f17n, gnu_kawa_slib_pregexp_frame0.lambda$Fn4, gnu_kawa_slib_pregexp_frame0.fk);
                                    ...
                                    return lambda3sub(lists.cadr.apply1(gnu_kawa_slib_pregexp_frame0.re$1), gnu_kawa_slib_pregexp_frame0.f9i, gnu_kawa_slib_pregexp_frame0.lambda$Fn5, gnu_kawa_slib_pregexp_frame0.fk);
                                } else {
                                    if (Scheme.isEqv.apply2(tmp, pregexp.Lit103) != Boolean.FALSE) {
                                        return lambda3sub(lists.cadr.apply1(gnu_kawa_slib_pregexp_frame0.re$1), gnu_kawa_slib_pregexp_frame0.f9i, this.identity, pregexp.lambda$Fn6) != Boolean.FALSE ? Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, gnu_kawa_slib_pregexp_frame0.f9i) : Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk);
                                    } else {
                                        if (Scheme.isEqv.apply2(tmp, pregexp.Lit104) != Boolean.FALSE) {
                                            return lambda3sub(lists.cadr.apply1(gnu_kawa_slib_pregexp_frame0.re$1), gnu_kawa_slib_pregexp_frame0.f9i, this.identity, pregexp.lambda$Fn7) != Boolean.FALSE ? Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk) : Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, gnu_kawa_slib_pregexp_frame0.f9i);
                                        } else {
                                            Object n$Mnactual;
                                            Object sn$Mnactual;
                                            Boolean found$Mnit$Qu;
                                            if (Scheme.isEqv.apply2(tmp, pregexp.Lit105) != Boolean.FALSE) {
                                                n$Mnactual = this.f17n;
                                                sn$Mnactual = this.sn;
                                                this.f17n = gnu_kawa_slib_pregexp_frame0.f9i;
                                                this.sn = gnu_kawa_slib_pregexp_frame0.f9i;
                                                ...
                                                this.f17n = n$Mnactual;
                                                this.sn = sn$Mnactual;
                                                return found$Mnit$Qu != Boolean.FALSE ? Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, gnu_kawa_slib_pregexp_frame0.f9i) : Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk);
                                                ...
                                                this.f17n = n$Mnactual;
                                                this.sn = sn$Mnactual;
                                                return found$Mnit$Qu != Boolean.FALSE ? Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk) : Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, gnu_kawa_slib_pregexp_frame0.f9i);
                                            } else if (Scheme.isEqv.apply2(tmp, pregexp.Lit109) != Boolean.FALSE) {
                                                found$Mnit$Qu = lambda3sub(lists.cadr.apply1(gnu_kawa_slib_pregexp_frame0.re$1), gnu_kawa_slib_pregexp_frame0.f9i, this.identity, pregexp.lambda$Fn10);
                                                ...
                                                if (x2 == Boolean.FALSE ? Scheme.isEqv.apply2(tmp, pregexp.Lit61) != Boolean.FALSE : x2 != Boolean.FALSE) {
                                                    ...
                                                    return lambda3sub(lists.cadr.apply1(gnu_kawa_slib_pregexp_frame0.re$1), gnu_kawa_slib_pregexp_frame0.f9i, gnu_kawa_slib_pregexp_frame0.lambda$Fn11, gnu_kawa_slib_pregexp_frame0.lambda$Fn12);
                                                    ...
                                                    try {
                                                        ...
                                                        gnu_kawa_slib_pregexp_frame0.f10p = lists.caddr.apply1(gnu_kawa_slib_pregexp_frame0.re$1);
                                                        gnu_kawa_slib_pregexp_frame0.f11q = lists.cadddr.apply1(gnu_kawa_slib_pregexp_frame0.re$1);
                                                        if (gnu_kawa_slib_pregexp_frame0.maximal$Qu) {
                                                            obj = gnu_kawa_slib_pregexp_frame0.f11q;
                                                            try {
                                                                int i2;
                                                        ...
                                                        return gnu_kawa_slib_pregexp_frame0.lambda8loupP(pregexp.Lit73, gnu_kawa_slib_pregexp_frame0.f9i);
                        ...
                        } else if (Scheme.numGEq.apply2(gnu_kawa_slib_pregexp_frame0.f9i, this.f17n) != Boolean.FALSE) {
                            return Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk);
                        } else {
                            return pregexp.pregexpError$V(new Object[]{pregexp.Lit101});
                        }
                ...
                } else if (pregexp.isPregexpAtWordBoundary(this.f18s, gnu_kawa_slib_pregexp_frame0.f9i, this.f17n) != Boolean.FALSE) {
                    return Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk);
                } else {
                    return Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, gnu_kawa_slib_pregexp_frame0.f9i);
                }
