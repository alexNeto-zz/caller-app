...
public class testing extends ModuleBody {
    ...
    public class frame1 extends ModuleBody {
        ...
        Object lambda9() {
            return ((Procedure) testing.test$Mnrunner$Mncurrent).apply1(this.f90r);
        }
    ...
    public class frame2 extends ModuleBody {
        ...
        boolean lambda12(Object runner) {
            this.f91i = AddOp.$Pl.apply2(this.f91i, testing.Lit13);
            Object apply2 = Scheme.numGEq.apply2(this.f91i, this.f92n);
            try {
                boolean x = ((Boolean) apply2).booleanValue();
                return x ? ((Boolean) Scheme.numLss.apply2(this.f91i, AddOp.$Pl.apply2(this.f92n, this.count))).booleanValue() : x;
            } catch (ClassCastException e) {
                throw new WrongType(e, "x", -2, apply2);
            }
        }
    ...
    public static void testResultRemove(Object runner, Object pname) {
        ...
        try {
            Object alist = testResultAlist((test$Mnrunner) runner);
            gnu_kawa_slib_testing_frame.f93p = lists.assq(pname, alist);
            if (gnu_kawa_slib_testing_frame.f93p != Boolean.FALSE) {
                try {
    ...
    public static Object testApply$V(Object first, Object[] argsArray) {
        ...
        gnu_kawa_slib_testing_frame1.f90r = testRunnerCreate();
        ...
        Object obj = gnu_kawa_slib_testing_frame1.f90r;
        try {
            return procedure.apply2(testRunnerOnFinal((test$Mnrunner) obj), gnu_kawa_slib_testing_frame1.f90r);
    ...
    public static Procedure $PcTestMatchNth(Object n, Object count) {
        ...
        gnu_kawa_slib_testing_frame2.f92n = n;
        gnu_kawa_slib_testing_frame2.count = count;
        gnu_kawa_slib_testing_frame2.f91i = Lit0;
