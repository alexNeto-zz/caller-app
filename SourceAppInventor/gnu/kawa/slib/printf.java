...
public class printf extends ModuleBody {
    ...
    public class frame4 extends ModuleBody {
        ...
        Object lambda13(Object i, Object fdigs) {
            ...
            if (Scheme.numGEq.apply2(i, Integer.valueOf(this.staticLink.staticLink.staticLink.f20n)) != Boolean.FALSE) {
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda2sign(Object i, Object cont) {
            if (Scheme.numLss.apply2(i, Integer.valueOf(this.f20n)) == Boolean.FALSE) {
                return Values.empty;
            }
            Object obj = this.str;
            try {
        ...
        public Object lambda3digits(Object i, Object cont) {
            ...
            Object j = i;
            while (true) {
                Object apply2 = Scheme.numGEq.apply2(j, Integer.valueOf(this.f20n));
                try {
        ...
        Object lambda5(Object i, Object sgn, Object digs, Object ex) {
            ...
            if (Scheme.numEqu.apply2(i, Integer.valueOf(this.f20n)) != Boolean.FALSE) {
    ...
    public static Object stdio$ClParseFloat(Object str, Object proc) {
        ...
        try {
            gnu_kawa_slib_printf_frame.f20n = strings.stringLength((CharSequence) obj);
    ...
    public static Object sprintf$V(Object str, Object format, Object[] argsArray) {
        ...
        gnu_kawa_slib_printf_frame13.f19s = obj;
        obj = gnu_kawa_slib_printf_frame13.f19s;
        try {
            ...
            if (Scheme.isEqv.apply2(gnu_kawa_slib_printf_frame13.end, gnu_kawa_slib_printf_frame13.cnt) != Boolean.FALSE) {
                return gnu_kawa_slib_printf_frame13.f19s;
            }
            obj = gnu_kawa_slib_printf_frame13.f19s;
            try {
                CharSequence charSequence = (CharSequence) obj;
