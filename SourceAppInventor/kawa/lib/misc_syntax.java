...
public class misc_syntax extends ModuleBody {
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda4f() {
            Object x = ports.read(this.f95p);
            if (!ports.isEofObject(x)) {
                return new Pair(std_syntax.datum$To$SyntaxObject(this.f94k, x), lambda4f());
            }
            ports.closeInputPort(this.f95p);
            return LList.Empty;
        }
    }
    ...
    static Object lambda3(Object x) {
        ...
        kawa_lib_misc_syntax_frame.f94k = execute;
        try {
            kawa_lib_misc_syntax_frame.f95p = ports.openInputFile(Path.valueOf(fn));
