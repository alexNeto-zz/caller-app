...
public class syntax extends ModuleBody {
    ...
    public static final Macro f99import;
    ...
    public static final Macro f100synchronized;
    ...
    static {
        ...
        f100synchronized = Macro.make(Lit25, new ModuleMethod(moduleBody, 3, null, 4097), $instance);
        ...
        f99import = Macro.make(Lit36, Lit37, $instance);
